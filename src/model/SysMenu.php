...
class SysMenu extends Model
{
    ...
    public static function onAfterWrite($model): void
    {
        ...
        \think\facade\Cache::delete('SysNodesInfo');
        \think\facade\Cache::delete('SysAuthNodes');
        \think\facade\Cache::delete('SysAuthNodesTree');
        \think\facade\Cache::delete('sys_all_menus');
    }
