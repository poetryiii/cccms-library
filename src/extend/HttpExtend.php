...
class HttpExtend
{
     ...
     */
    public static function get(string $location, array|string $data = [], array $options = []): bool|string
    {
        $options['query'] = $data;
     ...
     * @return boolean|string
     */
    public static function post(string $location, array|string $data = [], array $options = []): bool|string
    {
        $options['data'] = $data;
